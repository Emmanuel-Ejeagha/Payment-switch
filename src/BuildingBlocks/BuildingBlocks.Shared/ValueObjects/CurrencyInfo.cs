...
namespace BuildingBlocks.Shared.ValueObjects;

/// <summary>
/// ISO 4217 currency metadata shared across services so exponents are validated
/// and converted consistently at every API boundary (Payment, Ledger, Settlement).
/// </summary>
