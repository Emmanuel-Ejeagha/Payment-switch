...
import { Shield, ArrowRight, MailCheck } from "lucide-react"
      ...
      <div className="relative hidden w-1/2 flex-col justify-between bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-12 text-white lg:flex">
        ...
        <div className="space-y-6">
          ...
          <p className="max-w-md text-base text-slate-400">
            Reset your password and get straight back to managing merchants, payments, and the
        ...
        <div className="w-full max-w-sm space-y-8">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              {sent
                ? `We sent a password reset link to ${sent}. It expires in 1 hour.`
          ...
          {sent ? (
            <div className="space-y-4">
              <div className="flex items-center gap-3 rounded-lg bg-primary/10 p-4 text-sm text-primary">
